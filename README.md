...
> [!warning]
> Please note that:
> - the theme applies a fairly aggressive style to callouts to fit my own taste. Personally, I do not recommend extensive use of callouts or placing large amounts of formatted content inside callout blocks, as callouts are not really standard Markdown syntax.
> - if you do not disable the ribbon bar, there can be a glitch in its background color.
